...
//fm = left(p,i)
          ...
          else
        {
          ...
          if ($doedit)
          {
            ...
            print "<div id=\"fx\" class=\"fi\"><a href=\"conf.php?p=".rawurlencode($fm)."\"><img src=\"g.gif\" border=0></a><img src=\"h.gif\" height=14 width=".($level-1)*15."><img id=\"fx1\" src=\"o.gif\">".$f."</div>"."\r\n";
          }
            else
          {
      ...
      if ($MSIE)
      {
        ...
        if ($doedit)
        {
          ...
          if ($url!="")
          {
            $myurl[$level]=$myurl[$level]."<div class=\"bi\"><a href=\"conf.php?p=".rawurlencode($p)."\"><img src=\"g.gif\" border=0></a><img src=\"h.gif\" height=14 width=".$level*15."><img src=\"b.gif\"><a href=\"".$url."\">".$mytitle."</a></div>"."\r\n";
          } 
        }
          else
        {
          ...
          if ($url!="")
          {
            $myurl[$level]=$myurl[$level]."<div class=\"bi\"><img src=\"s.gif\" width=\"0\"><img src=\"s.gif\" height=10 width=".$level*15."><img src=\"a.gif\"><a href=\"".$url."\">".$mytitle."</a></div>"."\r\n";
          } 
        } 
