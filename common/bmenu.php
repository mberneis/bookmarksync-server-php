...
if (!is_array($bmenu))
{
  ...
  $bmenu=array(
    "LATEST NEWS","../common/news.php",
    "PROFILE","../common/profile.php",
    "PROFILE|REMOVE ME","../common/removeuser.php",
    "SURVEY","../common/survey.php",
    "TELL A FRIEND","../common/refer.php",
    "TELL A FRIEND|SHUTTLE","../common/syncitshuttle.php",
    "-","-",
    "PRIVACY","../common/policy.php",
    "LICENSE","../common/license.php",
    "-","-",
    "HELP","javascript:showhelp(8)",
    "HELP|BMSYNC","javascript:showhelp(4)",
    "HELP|MYSYNC","javascript:showhelp(5)",
    "HELP|NEWS","javascript:showhelp(6)",
    "HELP|EXPRESS","javascript:showhelp(7)",
    "HELP|FAQ","javascript:showhelp(1)",
    "HELP|SUPPORT","../help/support.php",
    "HELP|PC CLIENT","javascript:showhelp(3)",
    "HELP|MAC CLIENT","javascript:showhelp(2)",
    "-","-",
    "ABOUT US","../common/aboutus.php",
    "ABOUT US|BIO","../common/bio.php",
    "ABOUT US|PRESS","../common/press.php",
    "ABOUT US|PARTNER","../common/partner.php",
    "ABOUT US|ADVERTISE","../common/advertise.php",
    "-","-");
