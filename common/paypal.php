...
<p>
Thank you for your purchase through Paypal. Your license will be activated in the next 24 hours.
<?php
$body = "http://admin.syncit.com/admin/user.php?pid=" . $_SESSION['ID'];
domail("paypalconfirm@syncit.com","paypal@syncit.com","Paypal Confirmation #" . $_SESSION['ID'],$body);
?>
</p>
</td>
