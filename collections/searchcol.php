...
<?php include '../inc/chead.php'; ?>
          ...
          <td width="491" valign="top">
            <form method="POST" action="searchcol.php">
            <img src="../images/icon_searchcol.gif" width="84" height="65" align="right" vspace="10" alt="Search Collections">
            <br><h2>Search Collections</h2>

            <p class="menub">
            [<a href="../bms/searchbm.php"><font color="#3333FF">Want to search inside your Bookmarks? Click
            here!</font></a>]
            <p>

              <span class="menub"> &nbsp;ENTER SEARCH TERM</span><br>
              <input type="text" name="searchcol" class="register" size="30" value="<? echo $searchstr; ?>">
...
if ($searchstr != ""){
	...
	$token = strip($searchstr);
	$res = mysql_query("select publishid,person.name,publish.title,publish.user_id,publish.description,publish.anonymous from publish, person where publish.category_id > 0
							and publish.user_id = person.personid and (publish.title like '%" . $token . "%' or publish.description like '%" . $token . "%')");
	if (!$res)
		dberror("Cannot retrieve collections in searchcol.php");
...
?>
			...
			<td width="51" align="center"><a href="../tree/cview.php?ref=SEARCH&amp;pid=<?php echo $pid; ?>"><img src="../images/bsquare.gif" width="14" height="14" border="0" alt="View"></a></td>
			...
			<td width="58" align="center"><a href="invite.php?ref=SEARCH&amp;pid=<?php echo $pid; ?>"><img src="../images/ysquare.gif" width="14" height="14" border="0" alt="Invite"></a></td>
			</tr>
<?php
