...
// took out the subquery doing the count which will affect the ordering!!
$res = mysql_query("SELECT publishid,person.name,publish.title,publish.user_id,publish.description,publish.anonymous FROM publish, person WHERE publish.category_id > 0 AND publish.user_id = person.personid limit 20");
if (!$res)
	dberror("Cannot retrieve popular subscriptions in popular.php");
...
?>
	...
	<b>Most subscribed collections: </b>&nbsp;
	</td>
	</tr>
	<tr>
...
<?php
	while($data = mysql_fetch_assoc($res)){
		...
		$res1 = mysql_query("SELECT COUNT(*) FROM subscriptions WHERE publish_id=" . $data['publishid']);
	...
	?>
		...
		<td width="51" align="center"><a href="../tree/cview.php?ref=POPULAR&amp;pid=<?     echo $pid; ?>"><img src="../images/bsquare.gif" width="14" height="14" border="0" alt="View"></a></td>
		...
		<td width="58" align="center"><a href="invite.php?ref=POPULAR&amp;pid=<?     echo $pid; ?>"><img src="../images/ysquare.gif" width="14" height="14" border="0" alt="Invite"></a></td>
		</tr>
<?php
