...
if (!is_array($ymenu))
{
  ...
  $ymenu=array(
    ...
    "VIEW|REMOTE","../tree/remote.php\" target=\"sremote\" onclick=\"showremote();",
    "EDIT","../tree/edit.php",
    ...
    "TOP 50","../bms/stats.php",
    "-","-",
    "DOWNLOAD","../download/",
    "-","-",
    "PARTNERSHIP","../common/partner.php",
    "PROFILE","../common/profile.php",
    "PRIVACY","../common/policy.php",
    "HELP","javascript:showhelp(4)");

//UTILITIES|DEAD LINKS",		"../bms/deadlink.php",	_

  $GLOBAL["ymenu"] = $ymenu;
} 


//"UTILITIES|IMPORT",	"../bms/export.php",	
//"UTILITIES|ROAMING",		"../bms/roaming.php",	

$yimages = $GLOBAL["yimages"];
if (!is_array($yimages))
{
