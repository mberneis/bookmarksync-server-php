...
print "*M,upgrade.php"."\r\n";
print "*E,oldver"."\r\n"."*You are using an old version -- upgrade to the new BookmarkSync client now"."\r\n";
exit();
...
$tpath=substr($bm_row,0,$l-1); // *** get path
...
// *** Add Bookmark
  ...
  $bm_row=substr($bm_row,strlen($bm_row)-(strlen($bm_row)-3-strlen($tpath)));
