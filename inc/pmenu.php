      ...
      <table width="117" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="99" valign="top" bgcolor="#660099" background="../images/menu_news.gif"><img src="../images/newslogo.gif" width="99" height="77" alt="SyncIT News">
            <div class="newsdiv<? echo $BrowserType[]; ?>">
              <p class="menuw"><br>
...
<? 
  $pmenu = array(
    ...
    "HELP","javascript:showhelp(6)",
    "-","-\"");

//PARTNERSHIP",		"../common/partner.php",	_

  $pimages = array(
    "src='../images/ypmark.gif' width='9' height='15' align='absmiddle' alt='*'",
    "src='../images/pmark.gif' width='9' height='15' align='absmiddle' alt='&gt;'",
    "src='../images/ndot_on.gif' width='26' height='10' align='absmiddle' alt='*'",
